...
- **Preparation:** labels are lowercased, common trailing legal designators are removed, punctuation/non-ASCII bytes are discarded, normalized duplicates are removed, and only names of 2-12 ASCII letters are retained.
